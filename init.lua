...
vim.keymap.set('n', '<left>', '<cmd>echo "Fuck off! Use h to move!!"<CR>')
vim.keymap.set('n', '<right>', '<cmd>echo "Fuck off! Use l to move!!"<CR>')
vim.keymap.set('n', '<up>', '<cmd>echo "Fuck off! Use k to move!!"<CR>')
vim.keymap.set('n', '<down>', '<cmd>echo "Fuck off! Use j to move!!"<CR>')
